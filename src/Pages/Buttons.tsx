...
const Buttons = () => {
    return (
        ...
        <div className="flex space-y-1 space-x-3">
        ...
        <div className="flex space-y-1 space-x-3">
                <Btn btnText="Primary" btnType="primary" btnSize="xl"/>
                <Btn btnText="Danger" btnType="danger" btnSize="xl"/>
                <Btn btnText="Warning" btnType="warning" btnSize="xl"/>
                <Btn btnText="Success" btnType="success" btnSize="xl"/>
        </div>
        ...
        <div className="flex space-y-1 space-x-3">
                <IcBtn btnText="Primary" btnType="primary" btnSize="xl"/>
                <IcBtn btnText="Danger" btnType="danger" btnSize="xl"/>
                <IcBtn btnText="Warning" btnType="warning" btnSize="xl"/>
                <IcBtn btnText="Success" btnType="success" btnSize="xl"/>
        </div>
        </div>
